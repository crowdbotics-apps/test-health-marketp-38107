...
## Project Structure
    ...
    ├── test_health_marketp_38107  # Django project configurations
...
1. Clone this repo and `cd test_health_marketp_38107`
...
2. Clone this repo and `cd test_health_marketp_38107`
